...
updateFile('system.json', [
  ...
  { key: 'manifest', value: `https://raw.githubusercontent.com/coppolaop/cronicasrpg/${version}/system.json` },
  { key: 'download', value: `https://github.com/coppolaop/cronicasrpg/archive/${version}.zip` }
]);
